...
fun solvePartTwo(sequences: Iterable<Long>) : Long {
    ...
    return sequences
        ...
        .map { sum += it; sum}
        .first {
            !accumulatedSums.add(it)
        }
}

fun main(args: Array<String>) {
    val sequences = INPUT.split(",").map { it.toLong() }

    println("Sum of frequencies: ${solvePartOne(sequences)}")
    println("First duplicated frequency: ${solvePartTwo(sequences)}")
}